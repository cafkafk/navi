...
use super::{NaviError, NaviResult};
...
impl NixCheck {
    ...
    pub fn print_flakes_info(&self, required: bool) {
        ...
        if self.flakes_enabled {
            ...
            tracing::warn!("Navi will automatically enable Flakes for its operations, but you should enable it in your Nix configuration:");
