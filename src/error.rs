...
pub enum NaviError {
    ...
    #[snafu(display("Deployment error: {}", message))]
    ...
    #[snafu(display("Daemon connection error: {}", message))]
    DaemonConnectionError { message: String },

    #[snafu(display("Daemon error: {}", message))]
...
impl From<ValidationErrors> for NaviError {
    fn from(errors: ValidationErrors) -> Self {
        Self::ValidationError { errors }
    }
}

impl From<ExitStatus> for NaviError {
